...
class Courses(models.Model):
    ...
    credit_language_and_interpreting_skills = models.FloatField(default=0)
    credit_attitude = models.FloatField(default=0)
    credit_target_audiences = models.FloatField(default=0)
